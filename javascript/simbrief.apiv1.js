...
function checkSBworker()
	...
	//else
	//	{
	//	progress_file = 'http://www.simbrief.com/ofp/progress/'+timestamp+'_'+md5(document.getElementsByName('orig')[0].value+document.getElementsByName('dest')[0].value+document.getElementsByName('type')[0].value).toUpperCase().substring(0,10)+'.js';
	...
	*/
	...
	if (fe_result == 'true')
		...
		*/
		...
		//apiform.setAttribute("target", "_blank");	
